package marketplace.backend.config;
...
import marketplace.backend.security.auth.RestAuthenticationEntryPoint;
import marketplace.backend.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private AuthenticatedUserService jwtUserDetailsService;
